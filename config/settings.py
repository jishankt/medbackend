...
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "localhost,127.0.0.1,medbackend-1.onrender.com").split(",")
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.environ.get("REDIS_URL"),  # set this in Render env vars
        "OPTIONS": {
